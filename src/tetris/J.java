...
public class J extends Forma {

    public J(Color corNeutra) {
        super(corNeutra);
        cor = Color.CYAN;
        tipo = 'J';
        this.posicoes = 4;
    ...
    public void gira() {
        ...
        switch(orientacao) {
            case 2:
            /* J terá a orientação 2 (ainda não tem) */
                if(lateral > 7) lateral--;
                break;

            case 3:
            /* J terá a orientação 3 (ainda não tem) */
                lateral++;
                break;

            case 4:
            /* J terá a orientação 4 (ainda não tem) */
